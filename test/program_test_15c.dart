...
const _programs = [
  ...
  _Program(
    'Date and Time/Julian Date from Gregorian Date.15c',
  ...
  _Program(
    'HP Journal/HP Journal - 08.1980 p23 - W.M. Kahan.15c',
  ...
  _Program(
    ...
    // Result is 2.754e-89 in handbook:
  ...
  _Program(
    'Math/Gaussian Integration.15c',
    'RAD 5 STO I 1 ENTER 3 A -> 0.9026',
  ),
  _Program(
  ...
  _Program(
    'Math/Big_Factorial.15c',
    '235 A -> 456 X<=>Y -> 5.3275',
    pauseValues: [5.3275],
  ),
  _Program(
    'Math/Gamma function for complex numbers.15C',
    'f FIX 9 0 ENTER 1 I A -> -0.154949828 Re<=>Im -> -0.498015669',
  ),
  _Program(
    'Math/LnGammaComplex.15c',
  ...
  _Program(
    'Math/Convert to Fraction.15c',
    '0.15625 GSB 1 -> 32',
    pauseValues: [5],
  ),
  _Program(
    'Math/Little_Gauss.15c',
    '19 A -> 190 19 B -> 190 219 A -> 24090 219 B -> 24090',
  ),
  _Program(
    'Math/Calculating 208 digits of e.15c',
    '2 DIM (i) 1 A -> -0.71828178',
  ...
  _Program(
    'Users/D.G. Simpson/Kepler’s Equation.15c',
  ...
  _Program(
    'Users/D.G. Simpson/Projectile Problem.15c',
    '30 ENTER 50 ENTER 20 ENTER 30 f A -> 41.5357',
  ),
  _Program(
    'Users/D.G. Simpson/Hyperbolic Kepler’s Equation.15C',
    '60 ENTER 1.15 f A -> 1.7502',
  ),
  _Program(
    'Users/D.G. Simpson/Pendulum Period.15C',
    '1.2 ENTER 65 f A -> 2.3898',
  ),
  _Program(
    'Users/Eddie Shore/Prime Factorization.15c',
  ...
  _Program(
    'Users/Eddie Shore/Prime Factor.15c',
    '150 GSB B -> 2 R/S -> 3 R/S -> 5 R/S -> 5 R/S -> 150',
  ),
  _Program(
  ...
  _Program(
    'Users/Eddie Shore/Reactance chart solver.15c',
  ...
  _Program(
    'HP-15C Matrix/HP-15C Owner\'s Handbook - Pages 138-140.15c',
    'GSB 1 -> 8.2496',
  ...
  Future<void> waitProgramDone() async {
    for (;;) {
      ...
      if (out.current == ProgramEvent.runStop) {
        ...
        if (pv is num) {
          expect(
            c.model.formatValue(out.current.pauseValue!),
