...
class BackPanel16 extends BackPanel {
  ...
  Widget buildBackPanelPortrait(
    ...
    children: [
      ...
      screen.box(
        const Rect.fromLTWH(1.175, 1.8, 5.65, 6.5),
        operationTable(5.65),
      ),
  ...
  Widget errorTable(double widthCM) => table(widthCM, [
    ...
    row([
      ...
      cell(list([text('\u200aLBL?'), space(-0.7), text(',GTO>MEM,PRGM>203')])),
    ]),
    row([
  ...
  Widget operationTable(double widthCM) => table(widthCM, [
    ...
    row([
      ...
      cell(text('x', align: bpCenter)),
      cell(
        list([text('\u200aRMD\u22600'), arrowRight(2), space(0.4), text('C')]),
      ),
    ]),
    row([
      cell(
      ...
      cell(
        center(
          text(
            ...
            box: true,
            boxOffset: const Offset(-0.3, -0.08),
            scale: 0.88,
          ),
        ),
      ),
    ...
    row([
      ...
      cellEB(
        list([
          ...
          space(0.5),
          arrowRight(3.7),
          registerBox(20, list([space(1.3), point(), arrowRight(18.0)])),
          arrowRight(3.7),
          space(0.2),
          carry(),
        ]),
    ...
    row([
      ...
      cellEB(
        list([
          ...
          registerBox(24, list([space(1.3), point(), arrowRight(22.0)])),
          arrowRight(3.7),
          space(0.2),
          carry(),
        ]),
