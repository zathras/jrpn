/*
Copyright (c) 2022-2024 William Foote
...
class Matrix extends AMatrix {
  ...
  void resize(Model11 m, int rows, int columns) {
    if (rows < 0 || columns < 0) {
  ...
  void copyFrom(Model11 m, Matrix other) {
    if (other == this) {
      return;
    }
  ...
  ///             Y             Y     X
  ///
  void convertToZTilde(Model11 m) {
  ...
  ///
  void convertFromZTilde(Model11 m) {
    final rows = this.rows;
